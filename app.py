...
with dataset:
    ...
    patient_info = pd.read_csv(r"/app/bennett1993/ALY6080/Data/patient_info.csv")
    symptom_details = pd.read_csv(r"/app/bennett1993/ALY6080/Data/symptom_details.csv")
    ...
    if file == None:
        ...
        new_resulting_factors = pd.read_csv(r"/app/bennett1993/ALY6080/Data/new_resulting_factors.csv")
        tbi_incident = pd.read_csv(r"/app/bennett1993/ALY6080/Data/tbi_incident.csv")
