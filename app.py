...
with dataset:
    ...
    patient_info = pd.read_csv(r"/app/Data/patient_info.csv")
    symptom_details = pd.read_csv(r"/app/Data/symptom_details.csv")
    ...
    if file == None:
        additional_notes = pd.read_csv(r"/app/Data/additional_notes.csv")
        new_resulting_factors = pd.read_csv(r"/app/Data/new_resulting_factors.csv")
        tbi_incident = pd.read_csv(r"/app/Data/tbi_incident.csv")
